...
class CreateDockerfileTest {
    @Test
    void compareDockerfileBuiltOldstyle() {
        Project project = ProjectBuilder.builder().build()
        project.apply plugin: 'docker'

        Task task = project.task('docker', type: DockerTask)
        ...
        List<String> actual = task.buildDockerfile().instructions.each { it.toString() }
    ...
    @Test
    void compareDockerfileBuiltWithDSL() {
        Project project = ProjectBuilder.builder().build()
        project.apply plugin: 'docker'
